...
def parse_args():
    ...
    parser.add_argument(
        "--input-file",
        help="Arquivo JSON com saída do comando: kubectl get ingress -A -o json.",
    )
    ...
    parser.add_argument(
        "--traefik-nginx-compat",
        action="store_true",
        help=(
            "Ativa verificação de compatibilidade das annotations "
            "nginx.ingress.kubernetes.io/* com Traefik."
        ),
    )
    parser.add_argument(
        "--output-file",
